...
<html>
    <head>
        ...
        <meta property="og:title" content="email Notifikasi" />
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
																<h3 class="h3" style="text-align: center;">Order INV201291893032819</h3>
																<hr>
                                                                <div style="margin: 20px;">
																	<p>Pembayaran anda dengan No invoice inv12323123 Sebesar Rp.300000 Telah Kami Terima , Order Akan segera kami sampaikan pada merchant  untuk segera di proses. Terima Kasih</p>
																</div> 
                                                            </div>
														</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; *2019* *OKEBID*, All rights reserved.</em>
																<br>
																<a href="www.okebid.com">www.okebid.com</a> 
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
