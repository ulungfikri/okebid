...
class Api extends REST_Controller
{
    ...
    public function login_post(){
        ...
        $data = array('email' => $email , 'password' =>$password, 'status_merchant'=>'active');
        $stmt = $this->db->get_where('mt_merchant',$data);
        if ($stmt->num_rows()>0) {
    ...
    $this->load->library('email');
            ...
            $data = array('contact_name'=>$contact_name, 'email'=>$email,'merchant_name'=>$merchant_name,'password'=>$pass, 'activation_key'=>$activation_key,'activation_token'=>$ntoken, 'contact_phone'=>$contact_phone);
  
            $stmt_2 = $this->db->insert('mt_merchant',$data);
  ...
  echo json_encode(array("status" => FALSE));
    ...
    public function get_all_item_get(){
        $merchant_id = $this->input->post('merchant_id');
        $data = true; //$this->verify_request1();
        $output = array();
        if ($data === TRUE) {
    ...
    private function verify_request1()
    {
      ...
      //  $headers = $this->input->request_headers();
        ...
        try {
            $ntoken = generateToken($email.$password);
